...
- Monitor board for possible moves - display Game Over if no more moves exist
- Functions to detect and remove 3, 4 and 5 elements of the same color in a column and row
- Add score
- Functions for Drag & Drop functionality
- Function to refill board with elements once matches have been removed
